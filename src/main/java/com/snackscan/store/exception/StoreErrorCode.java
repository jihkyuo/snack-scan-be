...
public enum StoreErrorCode implements ErrorCode {
  ...
  INSUFFICIENT_STOCK(HttpStatus.BAD_REQUEST, "STORE_PRODUCT_003", "재고가 부족합니다."),
  ...
  INVALID_PRODUCT_INPUT(HttpStatus.BAD_REQUEST, "STORE_PRODUCT_002", "productId 또는 Product 생성 필드(name, brand, productPrice) 중 하나를 제공해야 합니다.");
